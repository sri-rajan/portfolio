  ...
  if (contactForm) {
    contactForm.addEventListener("submit", async function (e) {
      ...
      try {
        ...
        const response = await fetch("https://formspree.io/f/xbddyzdk", {
          method: "POST",
          headers: {
...
${data.message}
        ...
        const mailtoLink = `mailto:srirajanb781@gmail.com?subject=${emailSubject}&body=${emailBody}`;
